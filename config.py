...
BOT_TOKEN = environ.get("BOT_TOKEN", "7687702448:AAFWb9YEsY3C252_o1DL3HesAbqIRBQ_mu4")

PICS = (environ.get('PICS', 'https://graph.org/file/6a869326b7756a622bd48-6213fc97b75f7bfb30.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8494193109').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "tazzamaal909_bot") # without @
...
TERTIARY_SHORTLINK_API = environ.get("TERTIARY_SHORTLINK_API", "61f39d19af92336fad89e58e7167b58bfc3a390a") # 3rd shortlink api
FOURTH_SHORTLINK_URL = environ.get("FOURTH_SHORTLINK_URL", "nowshort.com") # 4th shortlink domain
FOURTH_SHORTLINK_API = environ.get("FOURTH_SHORTLINK_API", "31c39cb80de333c4bfda162a27e6dd7b71fda57d") # 4th shortlink api
FIFTH_SHORTLINK_URL = environ.get("FIFTH_SHORTLINK_URL", "liteshort.com") # 5th shortlink domain
FIFTH_SHORTLINK_API = environ.get("FIFTH_SHORTLINK_API", "04cb45af58e5912de37f89339c96d229642a3bba") # 5th shortlink api
SIXTH_SHORTLINK_URL = environ.get("SIXTH_SHORTLINK_URL", "instantlinks.co") # 6th shortlink domain
SIXTH_SHORTLINK_API = environ.get("SIXTH_SHORTLINK_API", "") # 6th shortlink api (initially empty)
